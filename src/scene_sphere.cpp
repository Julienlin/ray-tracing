...
SceneSphere::SceneSphere(ObjectBaseSurface *surface, position_t center, double radius, double reflect, double spec_reflect, double diff_reflect, double amb_reflect, double shine)
    : SceneBaseObject(surface, reflect, spec_reflect, diff_reflect, amb_reflect, shine), m_center(center), m_radius(radius) {}

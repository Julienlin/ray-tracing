/**
 * @file types.hpp
 * @author Julien Lin (you@domain.com)
 * @brief This file contains the daclaration of the class position_t and RGBColor.
 * @version 0.1
 * @date 2020-02-09
 *
 */
...
public:
  ...
  /**
   * @brief Overloading the operator of multiplication by a dot product. A new position_t is generated.
   *
   * @param pos Another position.
   * @return double
   */
  ...
  /**
   * @brief Overloading the operator of multiplication by a multiplication operation by a scalar. A new position_t is generated.
   *
   * @param c a scalar.
   * @return position_t
   */
  ...
  /**
   * @brief Overloading the operator of addition for vectoriel addition. A new position_t is generated.
   *
   * @param pos Another position.
   * @return position_t
   */
  ...
  /**
   * @brief Overloading the operator of substraction for vectoriel addition. A new position_t is generated.
   *
   * @param pos Another position.
   * @return position_t
   */
  ...
  /**
   * @brief Overloading operator. This operator is the cross product. A new position_t is generated.
   *
   * @return position_t
   */
  ...
  /**
   * @brief This method normalize the position. This is useful for the vector class.
   *
   * @return position_t&
   */
...
public:
  ...
  /**
   * @brief Construct a new RGBColor object. This constructor is generated by the compiler.
   *
  ...
  /**
   * @brief Overloading the =  operator. After initialisation the content is copied and the two instances remain.
   *
   * @return RGBColor&
   */
  ...
  /**
   * @brief Overloading += operator. The content of the caller instance is add with the content of the parameter.
   * The content of the parmater doesn't change.
   *
   * @return RGBColor&
   */
  RGBColor &operator+=(const RGBColor &);
...
/**
 * @brief Overloading * operator so RGBColor could works with double. a new RGBColor is created.
 *
 * @return RGBColor
 */
